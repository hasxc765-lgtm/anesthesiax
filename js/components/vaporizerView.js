 ...
 * - Result rendering
 *
 * It does NOT contain medical formulas.
 */
...
export function renderVaporizerView() {
  ...
  return `
    ...
    >
      ...
      >
        <div>
          ...
          >
            ...
            <span>
              حاسبة MAC والغازات الاستنشاقية
            </span>
          </h2>
      ...
      >
        ...
        >
          ...
          >
            ...
            <span>
              مؤشرات المخرة وحساب استهلاك السائل
            </span>
      ...
      <!-- DISCLAIMER -->
      <div
        class="p-3 bg-amber-50/80
               border border-amber-200
               rounded-2xl text-[11px]
               text-amber-900
               leading-relaxed space-y-1"
      >
        <div
          class="font-bold flex items-center
                 gap-1 text-amber-950"
        >
          <span>⚠️</span>
        ...
        <p>
          ${volatileAgentsData.meta.disclaimer}
        </p>

        <p>
          ${volatileAgentsData.meta.clinicalUseNotice}
        </p>
      </div>
...
export function initVaporizerEvents() {
  ...
  const updateResults = () => {
    const params = {
      ...
      endTidalPercent:
        endTidalInput?.value ?? 0,

      n2oPercent:
        n2oSelect?.value ?? 0,

      hasOpioid:
        opioidCheck?.checked ?? false,
    ...
    const assessment =
      VaporizerCalculator.processFullAssessment(
        params
      );
    ...
    if (!assessment.success) {
      resultsContainer.innerHTML = `
        <div
          class="p-3.5 bg-rose-50
                 border border-rose-200
                 text-rose-800 rounded-2xl
                 text-xs space-y-1.5
                 font-semibold"
        >
    ...
    const clinicalReview =
      macAssessment.requiresClinicalReview;
            ...
            clinicalReview
              ? `
                ...
                >
                  ⚠️
                  هذه النتيجة تتطلب
                  مراجعة سريرية ولا ينبغي
                  اعتبارها هدفًا تخديريًا
                  فرديًا.
                </div>
              `
              : ""
